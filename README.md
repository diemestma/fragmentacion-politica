...
- [code_figuras.do](/code_figuras.do). En este Do File se grafica el indicador $Fragmentación_{d}$, por provincia y región.[^2] Para el 2021, estos son los resultados:
...
[^2]: Los datos georeferenciados con los çódigos de las provincias en base al INEI se puede descargar de [aquí](https://www.geogpsperu.com/2014/03/base-de-datos-peru-shapefile-shp-minam.html).
